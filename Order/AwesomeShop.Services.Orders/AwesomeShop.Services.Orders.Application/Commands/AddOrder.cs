    ...
    public class AddOrder : IRequest<Guid>
    {
        ...
        public Order ToEntity()
        {
            return new Order(
                ...
                new DeliveryAddress(DeliveryAddress.Street, DeliveryAddress.Number, DeliveryAddress.City, DeliveryAddress.State, DeliveryAddress.ZipCode, DeliveryAddress.Observation),
                new PaymentAddress(PaymentAddress.Street, PaymentAddress.Number, PaymentAddress.City, PaymentAddress.State, PaymentAddress.ZipCode, PaymentAddress.Observation),
                new PaymentInfo(PaymentInfo.CardNumber, PaymentInfo.FullName, PaymentInfo.ExpireAt, PaymentInfo.Cvv),
